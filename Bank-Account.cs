...
namespace BankAccountProgram
{
    public class BankAccount
    {
        ...
        public decimal Amount
        {
            ...
            private set //if value is < 0 ,throws message for mistake 
                //else takes value 
            {
                if (value < 0) 
                {
        ...
        public void Deposit(decimal amount)  //if deposit is < 0, throws message for mistake
            //else take deposit plus amount 
        {
            if (amount < 0)
            {
