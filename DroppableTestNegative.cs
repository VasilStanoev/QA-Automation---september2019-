...
namespace Homework_SELENIUM_ADVANCED.InteractionTests
{
    class DroppableTestNegative
    {
        ...
        public void NegativeTest()
        {
            ...
            builder.DragAndDropToOffset(drag, 145, 25).Perform();// This work like upper!!!
            builder.MoveToElement(drag).ClickAndHold().MoveByOffset(145, 25).Release().Perform();
            ...
            Assert.AreNotEqual(515, drag.Location.X, "X coordinates are wrong");
            Assert.AreNotEqual(387, drag.Location.Y, "Y coordinates are wrong");
